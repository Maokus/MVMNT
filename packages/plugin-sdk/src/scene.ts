...
export abstract class CallbackElementRenderer {
    ...
    /** Transitional renderer facade implemented exclusively from SDK 2 DTOs. */
    protected hostApi(..._requirements: any[]): any {
        ...
        const audio = {
            ...
            sampleFeatureRange: (args: any) => {
                const value = unwrap(
                    context.audio?.sampleFeatureRange({
                        trackId: args.trackId,
                        feature: args.feature,
