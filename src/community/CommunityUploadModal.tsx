...
const CommunityUploadModal: React.FC<CommunityUploadModalProps> = ({
    user,
    canCreateTags = false,
    onClose,
    onUploaded,
                    ...
                    <div>
                        ...
                        {pluginUidConflict && pluginUid && (
                            <p className="mt-1 text-xs text-red-400">
                                A plugin with ID <span className="font-mono">{pluginUid}</span> already exists in the
                                community. Plugin IDs must be globally unique.
                            </p>
                        )}
                        {type === 'plugin' && mainFile && !pluginUid && (
                            <p className="mt-1 text-xs text-yellow-500">
                                Could not read manifest — plugin_uid won't be set.
                            </p>
                        )}
                    </div>
