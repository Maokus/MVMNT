...
import type { ExportKind, ExportSettings, ProgressData } from '@export/contracts';
import { DebugSettings } from './visualizer/types';
...
export function VisualizerProvider({ children }: { children: React.ReactNode }) {
    ...
    const { exportSequence, exportVideo, cancelExport, revealExport, removeExport } = useExportLifecycle({
        canvasRef,
        visualizer,
        totalDuration,
        exportSettings,
