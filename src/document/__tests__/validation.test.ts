...
import { createEmptyDocument, DocumentRoot } from '../schema';
...
describe('Phase 2 - Basic Validation', () => {
    ...
    it('Duplicate element ID detected', () => {
        const doc = createEmptyDocument();
        const el = { id: 'e1', name: 'Elem', start: 0, duration: 100 };
    ...
    it('Track referencing missing element produces error', () => {
        const doc = createEmptyDocument();
        doc.tracks.byId['t1'] = { id: 't1', name: 'Track 1', elementIds: ['missing'] };
