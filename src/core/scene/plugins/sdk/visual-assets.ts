...
export { ImageAssetSlot, AtlasAssetSlot, BundledImageAssetSlot, BundledSprite, AssetRefSlot, AssetRefAtlasSlot, type AssetSlotResult } from '@core/resources/visual-asset-slot';
