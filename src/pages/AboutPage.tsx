                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <section className="p-6 rounded-xl bg-neutral-900/70 border border-neutral-800">
                        ...
                        <ul className="space-y-2 text-sm text-neutral-300">
                            ...
                            <li>The Debug template shows every element type.</li>
                        </ul>
                    </section>
                    ...
                    <section className="md:col-span-2 p-6 rounded-xl bg-neutral-900/70 border border-neutral-800">
                        ...
                        <div className="flex flex-wrap gap-3 mt-5">
                            <Link to="/workspace" className="px-4 py-2 rounded bg-neutral-800 hover:bg-neutral-700 text-xs font-medium">Back to Edit Mode</Link>
