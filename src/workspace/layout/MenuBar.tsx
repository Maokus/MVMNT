                        ...
                        <div className="relative" ref={sceneMenuRef}>
                            ...
                            {showSceneMenu && (
                                ...
                                >
                                    ...
                                    <div className="px-3 py-2 text-neutral-300 cursor-pointer transition-colors text-[13px] flex items-center gap-2 hover:bg-white/10 hover:text-white first:rounded-t last:rounded-b" onClick={handleLoad}><FaFolderOpen /> <span>Open Scene…</span></div>
