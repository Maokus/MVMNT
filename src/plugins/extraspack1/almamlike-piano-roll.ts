...
export class AlmamlikePianoRollElement extends SceneElement {
    ...
    static override getConfigSchema(): EnhancedConfigSchema {
        return insertElementGroups(super.getConfigSchema(), {
            ...
            description: 'A piano roll like the moving notes piano roll but with the symbol',
        ...
        }, [
            {
                ...
                collapsed: false,
                properties: [
                    prop.midiTrack('midiTrackId', 'MIDI Track', { description: 'A piano roll like the moving notes piano roll but with the symbol' }),
                ],
            },
            {
                id: 'notesAppearance',
