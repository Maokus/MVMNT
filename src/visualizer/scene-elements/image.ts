        ...
        return {
            ...
            groups: [
                ...base.groups,
                {
                    ...
                    collapsed: false,
                    properties: [
                        { key: 'imageSource', type: 'file', label: 'Image File', default: '', accept: 'image/*', description: 'Image file to display' }
                    ]
                },
                {
                    id: 'layout',
                    ...
                    collapsed: false,
                    properties: [
                        { key: 'width', type: 'number', label: 'Width', default: 200, min: 10, max: 2000, step: 10, description: 'Width of the image container in pixels' },
                        { key: 'height', type: 'number', label: 'Height', default: 200, min: 10, max: 2000, step: 10, description: 'Height of the image container in pixels' },
                        { key: 'fitMode', type: 'select', label: 'Fit Mode', default: 'contain', options: [
                        ...
                        { key: 'preserveAspectRatio', type: 'boolean', label: 'Preserve Aspect Ratio', default: true, description: 'Whether to maintain the original aspect ratio' }
                    ]
                }
            ]
        };
