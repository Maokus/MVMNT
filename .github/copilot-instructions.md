...
When tasked to implement a new feature or write a plan for a new feature, do not use feature flags. Instead, implement the feature directly into the codebase.
