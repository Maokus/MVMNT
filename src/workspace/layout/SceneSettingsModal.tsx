...
const SceneSettingsModal: React.FC<SceneSettingsModalProps> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[9800] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div
                className="relative w-[840px] max-w-[95vw] rounded-lg border border-neutral-700 bg-neutral-900/95 p-5 shadow-2xl text-sm text-neutral-200 grid gap-x-8 max-h-[90vh] overflow-y-auto grid-cols-2"
                onClick={onModalClick}
            >
                <div className='col-span-2'>
                    <button
                        type="button"
                        className="absolute right-3 top-3 rounded-full border border-transparent p-1 text-neutral-400 transition-colors hover:text-white hover:bg-white/10"
                        onClick={onClose}
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4">
                        <label className="flex flex-col gap-1 text-[12px]">
                            ...
                            <input
                                ...
                                onKeyDown={(e) => { if (e.key === 'Enter') { commitSceneSetting('width'); (e.currentTarget as HTMLInputElement).blur(); } }}
                        ...
                        <label className="flex flex-col gap-1 text-[12px]">
                            ...
                            <input
                                ...
                                onKeyDown={(e) => { if (e.key === 'Enter') { commitSceneSetting('height'); (e.currentTarget as HTMLInputElement).blur(); } }}
                                className="number-input w-full"
                            />
                        </label>
                        <label className="flex flex-col gap-1 text-[12px]">
                            ...
                            <input
                                ...
                                onKeyDown={(e) => { if (e.key === 'Enter') { commitSceneSetting('fps'); (e.currentTarget as HTMLInputElement).blur(); } }}
                                className="number-input w-full"
                            />
                        </label>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mb-4">
                        <label className="flex flex-col gap-1 text-[12px]">
                            ...
                            <input
                                ...
                                onKeyDown={(e) => { if (e.key === 'Enter') { commitSceneRange(); (e.currentTarget as HTMLInputElement).blur(); } }}
                                className="number-input w-full"
                            />
                        </label>
                        <label className="flex flex-col gap-1 text-[12px]">
                ...
                <div className='cols-span-1'>
                    <div className="mb-4 flex flex-col gap-3 border-neutral-700 pt-3">
