                ...
                <div className="space-y-10">
                    ...
                    <ChangelogEntry
                        ...
                        notes={[
                            ...
                            'Internals',
                            ['Reduced compute load of MIDI Preview', 'Allow elements to access raw audio data'],
                        ]}
                    />
                    ...
                    <ChangelogEntry
                        version="0.11.3"
                        date="24-08-25"
                        notes={['Added Moving Notes Piano Roll', 'Fixed piano not rendering', 'General UI tidy-up']}
                    />
                    <ChangelogEntry
                        version="0.11.2"
                        date="17-08-25"
...
const ChangelogEntry: React.FC<{ version: string; date: string; notes: (string | string[])[] }> = ({
    version,
    date,
    notes,
}) => (
