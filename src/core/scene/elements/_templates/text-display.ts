...
export const textDisplay = definePluginElement({
    ...
    render(props) {
        ...
        if (props.showBackground) {
            ...
            let y =
                props.textBaseline === 'middle' ? -textHeight / 2 : props.textBaseline === 'bottom' ? -textHeight : 0;
        ...
        objects.push(
            new Text(0, 0, props.textContent, `${font.weight} ${props.fontSize}px ${font.family}, sans-serif`, {
