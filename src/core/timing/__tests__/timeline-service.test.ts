...
describe('Note query basics (store version)', () => {
    it('addMidiTrack with midiData and query notes in window (offsetTicks equivalent)', async () => {
        ...
        useTimelineStore.getState().setTrackOffsetTicks(id, 480); // 1 beat
